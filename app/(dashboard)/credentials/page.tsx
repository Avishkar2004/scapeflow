    ...
    <div className="flex flex-1 flex-col h-full">
      ...
      <div className="h-full py-6 space-y-8">
        <Alert>
          ...
          <AlertDescription>
            All information is securly encrypted, ensuring your daata remains
            safe
          </AlertDescription>
        </Alert>
      ...
      {credentials.map((credential) => {
        ...
        return (
          <Card key={credential.id} className="w-full p-4 flex justify-between">
            <div className="fekx gap-2 items-center">
              <div className="rounded-full bg-primary/10 w-7 h-8 flex items-center justify-center ">
